				...
				<div class="row">
                    ...
                    <div class="col-md-5">
						<div class="product-details">
							...
							<div>
								<h3 class="product-price">₱'.$row['product_price'].'<del class="product-old-price">₱1990.00</del></h3>
								<span class="product-available">In Stock</span>
							</div>
										<p>Flat iron-Dry/steam/spray/burst</p>
                                        <p>-1200W</p>
                                        <p>Code: HG-2015A</p>
												...
												<ul class="reviews">
													<li>
														<div class="review-heading">
															...
															<p class="date">18 JAN 2021, 8:00 PM</p>
														...
														<div class="review-body">
															<p>It has good quality. Thanks CitiHardware</p>
														</div>
													</li>
													<li>
														<div class="review-heading">
															<h5 class="name">Arian</h5>
															<p class="date">19 JAN 2021, 8:20 PM</p>
															<div class="review-rating">
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
														...
														<div class="review-body">
															<p>I love it. Very nice and affordable.</p>
														</div>
													</li>
													<li>
														<div class="review-heading">
															<h5 class="name">Darren</h5>
															<p class="date">20 JAN 2021, 10:12 AM</p>
															<div class="review-rating">
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
														...
														<div class="review-body">
															<p>I love the color. Very affordable and Nice to use. Thanks CitiHardware.</p>
														</div>
													</li>
												</ul>
